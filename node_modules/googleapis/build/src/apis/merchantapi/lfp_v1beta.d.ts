...
export declare namespace merchantapi_lfp_v1beta {
    ...
    export class Resource$Accounts$Lfpmerchantstates {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Accounts$Lfpmerchantstates$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Accounts$Lfpmerchantstates$Get, options?: MethodOptions): GaxiosPromise<Schema$LfpMerchantState>;
