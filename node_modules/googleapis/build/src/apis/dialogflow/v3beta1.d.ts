...
export declare namespace dialogflow_v3beta1 {
    ...
    export class Resource$Projects$Locations$Agents$Playbooks$Versions {
        ...
        restore(params?: Params$Resource$Projects$Locations$Agents$Playbooks$Versions$Restore, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDialogflowCxV3beta1RestorePlaybookVersionResponse>;
