...
export declare namespace paymentsresellersubscription_v1 {
    ...
    export class Resource$Partners$Subscriptions {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        resume(params: Params$Resource$Partners$Subscriptions$Resume, options: StreamMethodOptions): GaxiosPromise<Readable>;
        resume(params?: Params$Resource$Partners$Subscriptions$Resume, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudPaymentsResellerSubscriptionV1ResumeSubscriptionResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        suspend(params: Params$Resource$Partners$Subscriptions$Suspend, options: StreamMethodOptions): GaxiosPromise<Readable>;
        suspend(params?: Params$Resource$Partners$Subscriptions$Suspend, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudPaymentsResellerSubscriptionV1SuspendSubscriptionResponse>;
