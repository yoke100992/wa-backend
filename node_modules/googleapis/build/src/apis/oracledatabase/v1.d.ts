...
export declare namespace oracledatabase_v1 {
    ...
    export class Resource$Projects$Locations$Autonomousdatabases {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        switchover(params: Params$Resource$Projects$Locations$Autonomousdatabases$Switchover, options: StreamMethodOptions): GaxiosPromise<Readable>;
        switchover(params?: Params$Resource$Projects$Locations$Autonomousdatabases$Switchover, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
