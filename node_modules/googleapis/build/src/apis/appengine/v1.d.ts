...
export declare namespace appengine_v1 {
    ...
    export class Resource$Projects$Locations$Applications$Services$Versions {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Applications$Services$Versions$Patch, options: StreamMethodOptions): GaxiosPromise<Readable>;
        patch(params?: Params$Resource$Projects$Locations$Applications$Services$Versions$Patch, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
