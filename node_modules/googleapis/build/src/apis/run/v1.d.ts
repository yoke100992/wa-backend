...
export declare namespace run_v1 {
    ...
    export class Resource$Namespaces$Workerpools {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Namespaces$Workerpools$Create, options: StreamMethodOptions): GaxiosPromise<Readable>;
        create(params?: Params$Resource$Namespaces$Workerpools$Create, options?: MethodOptions): GaxiosPromise<Schema$WorkerPool>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Namespaces$Workerpools$Delete, options: StreamMethodOptions): GaxiosPromise<Readable>;
        delete(params?: Params$Resource$Namespaces$Workerpools$Delete, options?: MethodOptions): GaxiosPromise<Schema$Status>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Namespaces$Workerpools$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Namespaces$Workerpools$Get, options?: MethodOptions): GaxiosPromise<Schema$WorkerPool>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Namespaces$Workerpools$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Namespaces$Workerpools$List, options?: MethodOptions): GaxiosPromise<Schema$ListWorkerPoolsResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        replaceWorkerPool(params: Params$Resource$Namespaces$Workerpools$Replaceworkerpool, options: StreamMethodOptions): GaxiosPromise<Readable>;
        replaceWorkerPool(params?: Params$Resource$Namespaces$Workerpools$Replaceworkerpool, options?: MethodOptions): GaxiosPromise<Schema$WorkerPool>;
