...
export declare namespace classroom_v1 {
    ...
    export class Resource$Courses {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getGradingPeriodSettings(params: Params$Resource$Courses$Getgradingperiodsettings, options: StreamMethodOptions): GaxiosPromise<Readable>;
        getGradingPeriodSettings(params?: Params$Resource$Courses$Getgradingperiodsettings, options?: MethodOptions): GaxiosPromise<Schema$GradingPeriodSettings>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        updateGradingPeriodSettings(params: Params$Resource$Courses$Updategradingperiodsettings, options: StreamMethodOptions): GaxiosPromise<Readable>;
        updateGradingPeriodSettings(params?: Params$Resource$Courses$Updategradingperiodsettings, options?: MethodOptions): GaxiosPromise<Schema$GradingPeriodSettings>;
