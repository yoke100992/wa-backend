...
export declare namespace iamcredentials_v1 {
    ...
    export class Resource$Locations$Workforcepools {
         ...
         */
        getAllowedLocations(params: Params$Resource$Locations$Workforcepools$Getallowedlocations, options: StreamMethodOptions): GaxiosPromise<Readable>;
        getAllowedLocations(params?: Params$Resource$Locations$Workforcepools$Getallowedlocations, options?: MethodOptions): GaxiosPromise<Schema$WorkforcePoolAllowedLocations>;
    ...
    export class Resource$Projects$Locations$Workloadidentitypools {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getAllowedLocations(params: Params$Resource$Projects$Locations$Workloadidentitypools$Getallowedlocations, options: StreamMethodOptions): GaxiosPromise<Readable>;
        getAllowedLocations(params?: Params$Resource$Projects$Locations$Workloadidentitypools$Getallowedlocations, options?: MethodOptions): GaxiosPromise<Schema$WorkloadIdentityPoolAllowedLocations>;
