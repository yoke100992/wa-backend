...
export declare namespace networkservices_v1beta1 {
    ...
    export class Resource$Projects$Locations$Lbedgeextensions {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Lbedgeextensions$Create, options: StreamMethodOptions): GaxiosPromise<Readable>;
        create(params?: Params$Resource$Projects$Locations$Lbedgeextensions$Create, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Lbedgeextensions$Delete, options: StreamMethodOptions): GaxiosPromise<Readable>;
        delete(params?: Params$Resource$Projects$Locations$Lbedgeextensions$Delete, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Lbedgeextensions$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Projects$Locations$Lbedgeextensions$Get, options?: MethodOptions): GaxiosPromise<Schema$LbEdgeExtension>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Lbedgeextensions$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Projects$Locations$Lbedgeextensions$List, options?: MethodOptions): GaxiosPromise<Schema$ListLbEdgeExtensionsResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Lbedgeextensions$Patch, options: StreamMethodOptions): GaxiosPromise<Readable>;
        patch(params?: Params$Resource$Projects$Locations$Lbedgeextensions$Patch, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
