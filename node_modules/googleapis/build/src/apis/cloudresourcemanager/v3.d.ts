...
export declare namespace cloudresourcemanager_v3 {
    ...
    export class Resource$Folders$Capabilities {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Folders$Capabilities$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Folders$Capabilities$Get, options?: MethodOptions): GaxiosPromise<Schema$Capability>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Folders$Capabilities$Patch, options: StreamMethodOptions): GaxiosPromise<Readable>;
        patch(params?: Params$Resource$Folders$Capabilities$Patch, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
